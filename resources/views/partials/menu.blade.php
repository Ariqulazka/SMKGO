        ...
        @can('major_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.majors.index') }}"
                    class="c-sidebar-nav-link {{ request()->is('admin/majors') || request()->is('admin/majors/*') ? 'c-active' : '' }}">
        ...
        @can('school_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.schools.index') }}"
                    class="c-sidebar-nav-link {{ request()->is('admin/schools') || request()->is('admin/schools/*') ? 'c-active' : '' }}">
